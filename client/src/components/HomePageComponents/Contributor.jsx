...
export default function CodifyLearningComponent() {
  ...
  return (
    <section className={`py-20 px-4 ${isDark ? 'bg-dark-bg-primary' : 'bg-light-bg-primary'
      }`} data-aos="fade-right">
      <div
        className={`
          max-w-5xl mx-auto rounded-2xl p-12 border shadow-xl relative overflow-hidden ${isDark ? 'bg-dark-bg-secondary border-dark-border' : 'bg-light-bg-secondary border-light-border'
          }
        `}
      >
        {/* Background pattern */}
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <button
              ...
              className={`flex items-center justify-center px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl border ${isDark
          ...
          {showMotivation && (
            <div className={`rounded-lg p-6 shadow-inner border-l-4 border-primary transition-all duration-300 ${isDark ? 'bg-dark-bg-tertiary' : 'bg-light-bg-tertiary'
              }`}>
              ...
              <div className={`space-y-4 ${isDark ? 'text-dark-text-secondary' : 'text-light-text-secondary'
                ...
                <div className={`p-4 rounded-lg border-l-4 border-primary ${isDark ? 'bg-dark-bg-primary/50' : 'bg-light-bg-primary/50'
                  }`}>
                ...
                <div className={`flex items-center justify-center mt-6 p-4 rounded-lg ${isDark ? 'bg-primary/10' : 'bg-primary/10'
                  }`}>
